...
# ============================================================================
# IMPORTANTE: Agregar relaciones a modelos existentes
# ============================================================================

"""
MODIFICACIONES NECESARIAS EN TUS MODELOS EXISTENTES:

1. En Usuario (app/models/usuario.py):
   - Ya tienes las relaciones necesarias

2. En Renta (app/models/renta_reporte.py):
   - Agregar: pagos = relationship("Pago", back_populates="renta")

3. En Propiedad (app/models/propiedad.py):
   - Agregar: mensajes = relationship("Mensaje", back_populates="propiedad")
"""